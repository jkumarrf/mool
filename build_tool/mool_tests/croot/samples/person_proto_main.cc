...
#include "croot/common/address.pb.h"
#include "croot/samples/person.pb.h"

#include <stdio.h>

// The actual generated headers are available under:
//    ${BUILD_WORK_DIR}/croot/samples/person_proto_main

// Common protocol buffer headers are at:
//    /usr/local/include/google/protobuf/message.h

using cc_common::Address;
using cc_samples::Person;
using std::string;
